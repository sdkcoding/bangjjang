							...
							<tbody>
								<tr>
									...
									<td><select name="myreg_idx">
											...
											<option value='32216'>입금확인</option>
											<option value='40457' selected>문의하기</option>
