...
<body>
	<jsp:include page="../Page/head.jsp"></jsp:include>
		...
		<div class="container">
			...
			<div class="joinForm" >
				<!-- ---------------    body content : 38865 --------------- -->
				<form name='mem_reg_form' method="post" class="form-horizontal" role="form" 
				action='${contextPath }/userJoinWrite.do' target='ok_frame'>
							...
							<div class="col-xs-10 col-lg-10 col-sm-10">
								<div class="row">
									<div class="col-xs-4 col-lg-4 col-sm-4">
										...
										<span class="help-block" style="font-size: 10px;">6~10자리 숫자, 영 대소문자로 입력하세요. </span>
									</div>
									<button type='button' id="idOverlapCheck" class="btn btn-default" title='새창열림'>아이디
										중복체크</button>
					...
					<div class="form-group">
						<div class="row">
							<label for="password" class="col-xs-2 col-lg-2 col-sm-2 control-label">비밀번호<span style="color:red;">*</span></label>
							<div class="col-xs-10 col-lg-10 col-sm-10">
								<div class='row'>
									<div class="col-xs-4 col-lg-4 col-sm-4">
										<input type="password" name="password" id="password" size='12' maxlength='16'  
											class="form-control" required="required" />
										<span class="help-block" style="font-size: 10px;">8~15자리 숫자, 영문, 특수문자 각 한자리 이상 입력하세요.</span>
									</div>
									<div class="col-xs-6 col-lg-6 col-sm-6">
										<div class="row">
											<label for="password_re" class="col-xs-3 col-lg-3 col-sm-3 control-label">비밀번호확인<span style="color:red;" >*</span></label>
											<div class="col-xs-8 col-lg-8 col-sm-8">
												<input type='password' name='password_re' id='password_re' size='12' maxlength='16'  
												class="form-control" required="required" />
											</div>
										</div>
									</div>
					...
					<div class="farm-A-btn-wrap">
						<span class="farm-A-half">
							 <a href="#" id="joinWriteSubmit" class="farm-A-btn-circle farm-A-big farm-A-highlight">
	...
	<script type="text/javascript" src="${contextPath }/resource/js/joinWrite-check.js"></script>
