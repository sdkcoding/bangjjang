				...
				<div class="farm-A-customize-board">
					...
					<table class="farm-A-table farm-A-row farm-A-mgb" cellpadding="0"
						...
						<tbody>
							...
							<tr>
								<th>카톡아이디</th>
								<td>https://open.kakao.com/o/srI7SPL</td>
							</tr>
							<tr>
								<th>내용</th>
								<td>안녕하세요. 자격증 공부하고있는 30살 남자입니다. 하우스메이트 구하고 있어요. 학원이 종로쪽이라
									종로와 가까웠으면 합니다. 아침일찍 나가서 밤늦게 귀가하기때문에 부딪힐일은 많이 없을것 같구요. 평일엔 학원에서
									살고 주말 하루 집에서 쉽니다. 담배는 피지않고 술은 거의 안마시고 있어요. 집은 깔끔하게 쓰는 편입니다.
									생활패턴이 비슷한 분이면 서로에게 좋을것 같네요. 서로 큰 간섭 없이 있는듯 없는듯 지내실 분 오픈카톡 주세요
									:D</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="farm-A-table farm-A-row" cellpadding="0"
						...
						<tbody>
							...
							<tr>
								<th>접수상태</th>
								<td><span style="color: #FF3333;">대기중</span>
									<p class="farm-A-info"></p></td>
							</tr>
						</tbody>
					</table>

					<div class="farm-A-btn-wrap">
						<a href="javascript:myboard_read_back_board1_3()"
							class="farm-A-btn-type1 farm-A-medium">이전글</a> <a
							href="javascript:myboard_read_next_board1_3()"
							...
							href="javascript:myboard_edit_board1_3()"
							class="farm-A-btn-type1 farm-A-medium farm-A-highlight">수정</a> <a
							href="javascript:myboard_del_board1_3()"
