					...
					<form name='myboard_form_board1_3' enctype='multipart/form-data'
						...
						<div class="farm-A-btn-wrap">
							<span class="farm-A-half"> 
								<a href="javascript:myboard_list_board1_3()" class="farm-A-btn-circle farm-A-big">
									<span class="farm-A-big-txt">LIST</span>
									<span class="farm-A-small-txt">목록</span>
								</a> 
								<a href="javascript:myboard_form_board1_3_chk()" class="farm-A-btn-circle farm-A-big farm-A-highlight">
