		...
		margin-left: 0;
				...
				<div class="farm-A-customize-board">
					...
					<div class="farm-A-btn-wrap">
						<a href="javascript:myboard_read_back_board1_2()"
							class="farm-A-btn-type1 farm-A-medium">이전글</a> <a
							href="javascript:myboard_read_next_board1_2()"
							class="farm-A-btn-type1 farm-A-medium">다음글</a> <a
							href="javascript:myboard_list_board1_2()"
							class="farm-A-btn-type1 farm-A-medium" style="display: none;">목록</a>
						<a href="javascript:myboard_edit_board1_2()"
							class="farm-A-btn-type1 farm-A-medium farm-A-highlight">수정</a> <a
							href="javascript:myboard_del_board1_2()"
